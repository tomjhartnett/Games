...
namespace RNGItems
{
    ...
    public class TypeClass
    {
        ...
        public TypeClass(string Type, TextGenerator Namegenerator, List<string> Typemodifier, List<string> Qualities, List<Bitmap> possibleImages, List<Stat> Possiblerequired, List<Stat> Possiblegiven, List<Stat> Requiredrequired, List<Stat> Requiredgiven)
        {
            type = Type;
        ...
        public TypeClass(string Type, TextGenerator Namegenerator, List<Bitmap> possibleImages, ItemClass itemClass)
        {
            type = Type;
            nameGenerator = Namegenerator;
            images = possibleImages;
            typeModifier = itemClass.typeModifier;
            qualities = itemClass.qualities;
            possibleRequired = itemClass.possibleRequired;
            possibleGiven = itemClass.possibleGiven;
            requiredGiven = itemClass.requiredGiven;
            requiredRequired = itemClass.requiredRequired;
        }
